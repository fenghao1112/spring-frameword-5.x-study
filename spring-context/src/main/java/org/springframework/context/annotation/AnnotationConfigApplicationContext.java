...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		...
		// 可以用来扫描包，或者类，继而转换成beanDefinition
		// 但是spring中扫描包的工作不是scanner这个对象来完成的，是spring另外实例化的一个ClassPathBeanDefinitionScanner对象
		// 这里的scanner仅仅是为了让程序员可以在外部使用AnnotationConfigApplicationContext的scan()方法。
